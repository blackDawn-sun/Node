...
<!-- 这是一张图片，ocr 内容为： -->
![计算机硬件](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052439.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![计算机软件](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052449.png)
...
## 计算机语言、代码、程序
<!-- 这是一张图片，ocr 内容为： -->
![计算机语言、代码、程序](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052457.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![世界第一台计算机](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052520.jpg)<!-- 这是一张图片，ocr 内容为： -->
![世界第一台计算机](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052525.jpg)
...
<!-- 这是一张图片，ocr 内容为： -->
![编译型语言](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052531.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![解释型语言](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052536.png)
...
### Python 的起源
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052542.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052547.png)

**Python 的缺点：**

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052551.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052556.png)

**② **随后输入：`print(100)`，随后回车，终端中呈现`100`

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052562.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052567.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052572.png)

3️⃣修改安装目录，点击下一步。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052578.png)

4️⃣勾选对应的安装选项，之后点击下一步。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052584.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052593.png)

6️⃣安装完成。

<!-- 这是一张图片，ocr 内容为：PYCHARM 安装 PYCHARM安装程序结束 PC PYCHARM  已经成功安装到本机. 点击[完成(F)]关闭安装程序. 运行 PYCHARM(R) <上一步(R 完成(F) 取消(C) -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052598.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052604.png)

提示是否共享数据，若共享就会将部分使用数据发送给 `Jetbrains`公司优化产品，我这里选择不共享。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052610.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052617.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052621.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052626.png)

4️⃣若出现如下提示，点击【排除文件夹】即可

<!-- 这是一张图片，ocr 内容为：MICROSOFT DEFENDER 可能会影响IDE 为避免性能问题,请从实时保护中排除IDE和项目 文件夹:... 更多 排除文件夹 -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052630.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052636.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052641.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052647.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052652.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052657.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052663.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052668.png)	
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052673.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052678.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052687.png)

4️⃣随后窗口中会自动识别当前按下的按键和鼠标动作，随后点击确定即可。

<!-- 这是一张图片，ocr 内容为：鼠标快捷方式 在所有编辑器中减小字体大小在编辑器操作中 CTRL+向下滚动滚轮 取消 确定 -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052692.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052697.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052702.png)	

### **脚本模式	**
1. 在桌面上新建一个`code`文件夹，随后新建一个文本档，将其重命名为`test.py` 

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052707.png)<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052713.png)

2. 使用记事本打开`test.py`，在其中写好代码并保存。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052743.png)

3. 找到`test.py`所在的文件夹

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052749.png)

4. 在资源管理器上方输入`cmd`并回车，就会打开命令提示符并进入当前路径。

<!-- 这是一张图片，ocr 内容为：桌面 输入CMD 在桌面中搜索 X CMD 详细信息 三查看 新建 个排序 -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052753.png)

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052758.png)

5. 在命令提示符中输入`python test.py`执行程序，就会看到打印的内容。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052765.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052770.png)

2. 输入文件名，确认后按下回车

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052776.png)

3. 输入`print(100)`，随后在文件空白处点击鼠标右键，选择：`运行test`。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052782.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052788.png) <!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052792.png) <!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052796.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052802.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052809.png)

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052814.png)

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052819.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052824.png) |
| **float(x)** | 将x转换为一个浮点数 | <!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052830.png) |
| **str(x)** | 将对象x转换为一个字符串 | <!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052835.png) |
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052841.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052848.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052856.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052866.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052877.png)

但布尔类型的具体值，只有两个，分别是：`True`和`False`，其中：`True`表示真，`False`表示假。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052890.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052903.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![十进制数：9527](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052914.png)<!-- 这是一张图片，ocr 内容为： -->
![二进制数：1010](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052924.png)

<!-- 这是一张图片，ocr 内容为： -->
![八进制数：1034](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052940.png)<!-- 这是一张图片，ocr 内容为： -->
![十六进制数：1CF](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052952.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052969.png)

2️⃣借助 Python 提供的内置函数，实现进制转换

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052985.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115052993.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053000.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053030.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053036.png)

**3️⃣****案例：**

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053040.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053046.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053053.png)
...
### 对比 while 与 for
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053057.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053062.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053067.png)
...
### 综合案例
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053072.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![智能家居场景 VS 函数](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053078.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053083.png)

### **Python 中函数的分类**
Python 中函数分为三类：①内置函数、②模块提供的函数、③自定义函数。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053088.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053093.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053097.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053101.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053109.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053113.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053117.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053121.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053126.png)

## 函数综合案例
完成一个健身挑战赛程序，功能演示见下图：

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053132.gif)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053136.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053141.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![正索引](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053146.png)

<!-- 这是一张图片，ocr 内容为： -->
![负索引](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053152.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053157.png)

在上述写法中，如果只看`append(元素)`，这就是在调用`append`函数，但`append`前面还有`列表.`这种形式，所以也可以换一个说法，叫：调用列表的`append`方法。

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053161.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053166.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053170.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053189.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053180.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053184.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053194.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![人类](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053200.png)<!-- 这是一张图片，ocr 内容为： -->
![汽车类](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053205.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![类进行实例化，得到实例对象](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053210.png)<!-- 这是一张图片，ocr 内容为： -->
![类进行实例化，得到实例对象](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053215.png)
...
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053220.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053225.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053229.png)

3️⃣ 可变对象：修改内容不改变地址

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053233.png)

4️⃣自定义类对象的内存表示

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053238.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053244.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053250.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053255.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053260.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053267.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053272.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053277.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053282.png)

## 创建全局环境项目
通过 Pycharm 创建项目时，进行如下配置，即可创建全局环境：

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053287.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053315.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053329.png)  <!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053329.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053336.png)

GIl 锁何时会被释放？ —— 主动释放（遇到 I/O 操作）、被迫释放（任务超时）

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053342.png)

可以使用多进程来发挥多核 CPU 的性能

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053347.png)

GIL 对比 lock/Rlock：

<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053351.png)
...
## 多进程 vs 多线程，该如何选择？
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053356.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](md/学习/语言学习/python/assets/尚硅谷大模型技术之Python3.0/file-20260722115053363.png)
